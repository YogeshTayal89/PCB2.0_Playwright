...
export default class PCBPlayerDetailPage {
    ...
    basictabloc: Locator; marketingtabloc: Locator; cardstabloc: Locator; commentstabloc: Locator; relationstabloc: Locator; gamingtabloc :Locator;
    playerid:Locator;
 ...
 //gamingtabloc
     ...
     /**
      * This method is used to verify the GamingProfile tab is present in search result page
      */
     async verifyGamingProfileTabIsPresent() {
        await this.util.waitForPagetoLoad(this.page, 2000);
        await this.util.verifyElementPresent(this.gamingtabloc)
    }

    /**
    * This method is used to click on the GamingProfile tab
    */
    async clickOnGamingProfileTab() {
        await this.util.waitForPagetoLoad(this.page, 3000);
        await this.util.clickElement(this.gamingtabloc);
