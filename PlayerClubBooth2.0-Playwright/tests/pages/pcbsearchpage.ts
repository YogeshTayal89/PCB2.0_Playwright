...
export default class PCBSearchPage {
    ...
    errormsgmorethan100chars: Locator;
    ...
    constructor(page: Page) {
        ...
        this.errormsgmorethan100chars = this.framelocator.getByText("Please enter less than 100 characters to search player");
    ...
    /**
     * This method is used to verify the error message for more than 100 chars
     */
    async verifyErrorMessageforGreaterThan100chars() {
        await this.util.verifyElementPresent(this.errormsgmorethan100chars);
    }
