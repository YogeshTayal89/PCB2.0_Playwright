...
export default class PCBEnrollContactPage {
    ...
    constructor(page: Page) {
      ...
      //this.deletephones=this.framelocator.locator('//div[4]/div[1]/div/div/div/ul[1]/li/div/div[2]/igt-icon/div/span');
        this.deletephones=this.framelocator.locator('//div[4]/div[1]/div/div/div/ul[1]/li/div/div[2]/div/igt-icon/div/span');
        ...
        this.deleteemails=this.framelocator.locator('//div[4]/div[1]/div/div/div/ul[2]/li/div/div[2]/div/igt-icon/div/span')
...
async verifyEnteredContactsDetails(testdata:any){
    ...
    await this.util.verifyTextPresent(this.emailtype,'Main Email');
...
async verifyErrorMsgForSlectingAlreadyAddedType(testdata:any){
    ...
    await this.util.clickElement(await this.getDropdownValue(testdata.phonetype));
    await this.util.verifyContainsText(this.phonetypeerrormsg,'Please select different "Type".')
