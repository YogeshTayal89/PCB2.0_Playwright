...
test.describe('PCB Player Detail Marketing Tab Suite', () => {
    ...
    test.beforeEach(async ({ page }) => {
        ...
        await test.step('When I can do the search using any matching text', async () => {
            ...
            await pcbsearchpage.doSearch(marketingdata.playerid+ ","+marketingdata.firstname);
    ...
    test('Scenario Outline: As a user , I can see redeem button is enabled under marketing tab @MarketingTab @Regression', async ({ page }) => {
    ...
    test('Scenario Outline: As a user , I can see success message while redeeming valid coupon id @MarketingTab @Regression', async ({ page }) => {
        ...
        await test.step('When I can redeem a valid coupon id', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.redeemCoupon(marketingdata.validcouponid);
        });

        await test.step('Then I can see the error message', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.verifyRedeemMessageOfCoupon("success",marketingdata.validcouponid);
        });
    ...
    test('Scenario Outline: As a user , I can see mandatory field validation message if we are not entering anything on competitor Coupon field and click redeem button @MarketingTab @Regression', async ({ page }) => {
        await test.step('Then I can see Marketing details page ', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.verifyMarketingDetailsPageIsPresent();
        });

        await test.step('When click redeem button in the redeem popup without entering competitor coupon field then I can see the error message ', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.verifyMandatoryFieldOfCompetitorCouponInput();
        });

    });

    test('Scenario Outline: As a user , I can see success message while redeeming valid competitor Coupon id and click redeem button @MarketingTab @Regression', async ({ page }) => {
        await test.step('Then I can see Marketing details page ', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.verifyMarketingDetailsPageIsPresent();
        });
        ...
        await test.step('When I can redeem a valid coupon id', async () => {
            const pcpplayermarketingdetailpage=new PCBPlayerMarketingDetailsPage(page);
            await pcpplayermarketingdetailpage.redeemCompetitorCoupon(marketingdata.compcouponid);
        });
    });
