...
test.describe('PCB Enroll Marketing Suite', () => {
    ...
    test('Scenario Outline: As a user , I can enter all values with Point retirement checked in enroll marketing page @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
        ...
        await test.step('Then I can enter all the values in marketing', async () => {
            ...
            await pcbenrollmarketingpage.clickPointRetirementExempt();
        });
        ...
        await test.step('Then I can verify all the values are entered in Marketing', async () => {
            ...
            await pcbenrollmarketingpage.verifyPointRetirementExemptChecked();
        });

    });

    test('Scenario Outline: As a user , I can enter all values in enroll marketing page with Point Retirement not checked  @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
    ...
    test('Scenario Outline: As a user , I can see Enrollment Source value is present  @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
        ...
        await test.step('Then I can see Enrollment souce is prefilled in marketing', async () => {
            //  await pcbenrollmarketingpage.verifyEnrollmentSourcePresent(username);
            await pcbenrollmarketingpage.verifyEnrollmentSourcePresent(username);
    ...
    test('Scenario Outline: As a user , I can see error message if Enrollment Source value is cleared  @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
        ...
        await test.step('Then I can see error message if Enrollment Source value is cleared', async () => {
            await pcbenrollmarketingpage.verifyErrorMessageOfSource();
    ...
    test('Scenario Outline: As a user , I can see popup if Enrollment Source value is not valid  @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
        ...
        await test.step('hen I can see  pop up after entering for Enrollment Source value is not valid', async () => {
            await pcbenrollmarketingpage.verifyEnteringInvalidEnrollmentSource(enrollmentdata);
            await pcbenrollmarketingpage.clickOnSourceOkButton();

        });

        await test.step('Then I can see error message', async () => {
            await pcbenrollmarketingpage.verifyErrorMessageOfSource();
    ...
    test('Scenario Outline: As a user , I can enter invalid user and then correct it and continue enrollment  @Smoke @Marketing @Regression', async ({ page }) => {
        const pcbenrollmarketingpage = new PCBEnrollMarketingPage(page);
        ...
        await test.step('hen I can see not autorized pop up after entering invalid user', async () => {
            await pcbenrollmarketingpage.verifyEnteringInvalidEnrollmentSource(enrollmentdata);
            await pcbenrollmarketingpage.clickOnSourceOkButton();
        ...
        await test.step('Then i can enter the correct Enrollment source and continue enrollment clicking next', async () => {
            await pcbenrollmarketingpage.verifyEnteringValidEnrollmentSource(username);
            await pcbenrollmarketingpage.clickOnNextButton();
        });
