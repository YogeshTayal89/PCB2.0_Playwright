...
test.describe('PCB Search Page Suite', () => {
    ...
    test('Scenario Outline: As a user , I can see enroll button in the search page @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for fullname @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for SSN @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for DriverLicenseID @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using  DriverLicense', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.licenseid);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Players DOB @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Players Email ID @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using Email ID of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.email);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for PlayerID @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for FirstName of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
    ...
    test('Scenario Outline: As a user , I can see no search result message for MiddleName of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
        ...
        await test.step('When I can do the search using Passport Number of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.middlename);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for LastName of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
        ...
        await test.step('When I can do the search using FirstName of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.lastname);
        });
    ...
    test('Scenario Outline: As a user , I can see the error message for more than hundred max limit char text while searching a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using more than 100 char text', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.morethan100char);
        });

        await test.step('Then I should see the error message', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifyErrorMessageforGreaterThan100chars();
        });

    });


    test('Scenario Outline: As a user , I can verify search is working for three comma separated different values @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
        ...
        await test.step('When I can do the search using comma separated text', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.firstname+","+searchtestdata1.ssnid+","+searchtestdata1.dob);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Passport Number of a player @Search @Regression', async ({ page }) => {
        ...
        await test.step('When I can do the search using Passport Number of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.passportnumber);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Phone Number of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using Phone Number of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.phonenum);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Numeric Document ID of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using Numeric Document ID of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata2.passportnumber);
        });
    ...
    test('Scenario Outline: As a user , I can verify search is working for Alpha Numeric document ID of a player @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });

        await test.step('When I can do the search using Alpha Numeric document ID of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch(searchtestdata1.passportnumber);
        });
    ...
    test('Scenario Outline: As a user , I can see no search result message for invalid search criteria @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
        ...
        await test.step('When I can do the search using Passport Number of a player', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.doSearch("souths");
        });
    ...
    test('Scenario Outline: As a user , I can see Gaming Profile Tab in player details page @Search @Regression', async ({ page }) => {
        await test.step('Then I should see PCB Search Page', async () => {
            const pcbsearchpage = new PCBSearchPage(page);
            await pcbsearchpage.verifySearchPageIsPresent();
        });
        ...
        await test.step('Then I can see the Gaming Profile Tab in player details page', async () => {
            const pcbplayerdetailpage = new PCBPlayerDetailPage(page);
