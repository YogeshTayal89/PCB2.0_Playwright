...
test.describe('PCB Player Detail Comments Tab Suite', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('Scenario Outline: As a user , I can navigate to player details comments tab page @CommentsTab @Smoke @Regression', async ({ page }) => {
        await test.step('Then I can navigate to Comments tab page', async () => {
           ...
           pcbplayercommentdetailpage.verifyCommentDetailsPageIsPresent();
        });
